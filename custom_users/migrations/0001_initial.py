    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('Админ', 'Aдмин'), ('VIP Клиент', 'VIP Клиент'), ('Клиент', 'Клиент')], max_length=100, verbose_name='Тип пользователя')),
                ...
                ('orientation', models.CharField(choices=[('STRAIGHT', 'STRAIGHT'), ('GAY', 'GAY'), ('LESBIAN', 'LESBIAN')], max_length=100, verbose_name='Ориентация')),
                ...
                ('dump', models.IntegerField(choices=[(1, 'YES!'), (2, 'NO!'), (3, 'I DONT KNOW!')], verbose_name='Вы глупы?')),
            ],
            options={
